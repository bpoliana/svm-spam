...
def execute():
    ...
    print('Preprocessando sample email ', filename, '...')

    with open('emails_teste/emailSample1.txt') as f:
        file_contents = f.read().rstrip(Tde'\n')
    ...
    filename = 'emails_teste/emailSampleMedium.txt'
